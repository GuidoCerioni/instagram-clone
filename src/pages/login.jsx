  ...
  return (
    <>
      ...
      >
        ...
        justify-center items-center h-5/6"
        >
          <div className="flex">
            <img
          ...
          <div className="flex flex-col w-2/5">
            ...
            border rounded border-gray-primary mb-4"
            >
            ...
            bg-white p-4 border rounded border-gray-primary"
            >
              <p className="text-sm">
                Don`t have an account?
                {` `}
                {/* empty space between '?' and 'Sign'*/}
        ...
        <footer
          ...
          mx-auto max-w-screen-md  h-1/6 text-gray-400"
        >
